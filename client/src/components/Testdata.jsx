        ...
        <div className='px-4 sm:px-20 xl:px-32 py-16 '>
            ...
            <div className='flex flex-wrap mt-5 justify-center'>
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-black hover:shadow-2xl hover:shadow-yellow-400 shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
