  ...
  return (
      ...
      <div className='w-full max-w-lg p-6 rounded-lg flex flex-col min-h-90 max-h-[500px] border border-gray-300 bg-white'>
        <div className='flex items-center gap-3'>
          ...
          <h1 className='font-semibold text-xl'>Remove Background</h1>
        </div>

        <div className='flex flex-1 justify-center items-center gap-4'>
          <div className='flex gap-4 items-center flex-col text-sm'>
            <Eraser className='w-9 h-9  ' />
            <h1 className='text-gray-500 text-sm text-center'>Upload an image and click "Remove Background" to get started</h1>
          </div>
        </div>
      </div>
    </div>
