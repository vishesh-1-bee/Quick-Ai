    ...
    <div className='p-6 h-full   flex overflow-y-scroll items-start flex-wrap gap-9 text-slate-800 '>
      ...
      <form onSubmit={handleSubmit}
        ...
        <span className='flex items-center gap-3 w-full'>
          <Sparkles className='w-6 text-sky-600' />
      ...
      <div className='w-full max-w-lg p-6 rounded-lg flex flex-col min-h-98 max-h-[600px] border border-gray-300 bg-white'>
        <div className='flex items-center gap-3'>
          <Scissors className='w-5 h-5 text-purple-600' />
          <h1 className='font-semibold text-xl'> Processed Image</h1>
        </div>

        <div className='flex flex-1 justify-center items-center gap-4'>
          <div className='flex gap-4 items-center flex-col text-sm'>
            <Scissors className='w-9 h-9  ' />
            <h1 className='text-gray-500 text-sm text-center'>Upload an image and click "Remove Object" to get started</h1>
          </div>
        </div>
      </div>
    </div>
