...
import { Eraser, File, Hash, House, Image, LogOut, Scissors, SquarePen, User } from 'lucide-react'
...
const Sidebar = ({ mobile, setmobile }) => {
  ...
  return (
    <div
      className={` w-60 flex flex-col border-slate-400 items-center max-sm:absolute border-r max-sm:bg-slate-600  top-14 bottom-0 rounded 
    ...
    >
      ...
      {/* Nav Items */}
      <div onClick={() => setmobile(false)} className="flex flex-col gap-4 mt-6 w-full px-4">
